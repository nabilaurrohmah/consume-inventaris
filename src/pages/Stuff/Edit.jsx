                ...
                <div className="block m-auto h-screen bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <div className="items-center m-5 pb-10 pt-10">
                        ...
                        <div className="flex justify-center">
                            <h5 className="mb-1 m1-5 text-3x1 font-medium text-gray-900 dark:text-white">Edit Stuff</h5>
                        </div>
                        <from onSubmit={handleEditStuff} class="max-w-sm mx-auto">
                            <div class="mb-5">
                            ...
                            <div class="mb-5">
                                ...
                                dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onChange={e => setForms({...forms, category: e.targer.value})}>
